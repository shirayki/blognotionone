...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '梦幻之境，次元交汇, 穿越时空，探索无限,奇迹之旅，永不止步,幻想世界，尽在眼前, 光影交错，梦境重生,星辰大海，勇者无畏, 次元之门，开启奇迹,幻梦成真，勇敢追寻,炫酷之旅，尽享奇幻,欢迎来到我的博客🎉',
  ...
  TianliGPT_JS: process.env.NEXT_PUBLIC_TIANLI_GPT_JS || 'https://blog.ntb.us.kg/js/custom.js',
  TianliGPT_KEY: process.env.NEXT_PUBLIC_TIANLI_GPT_KEY || 'sehckahhkhkfe',
  ...
  COMMENT_TWIKOO_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_TWIKOO_CDN_URL || 'https://cdn.staticfile.org/twikoo/1.6.31/twikoo.min.js', // twikoo客户端cdn
